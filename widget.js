...
const widget = `   <style>
      /* Inline CSS styles for the campspace widget */
      .campspace-widget {
...
--campspace-width-card: 550px;
height: var(--campspace-height-card);
width: var(--campspace-width-card);
...
<article popover id="my-popover-widget">
  ...
  <div class="widget-images-slider">
      ...
      <img src="/images/luxury_tent_landscape_960.jpeg" alt="">
  ...
  <div class="widget-content-overlay">
      <img width="/" height="/" src="/images/campspace-logo-white.png" alt="logo campspace">
      <p>from € 22</p>
      <div> <a
              href="https://campspace.com/en/s/landgoed-met-zwemvijver-vuurplaatsen-2ha-wandelgebied_3606?pitchTypeId=1631&">Book
              Now</a></div>
  </div>
